...
> **Documentação Técnica Completa** | *Para regras de desenvolvimento, consulte [copilot-instructions.md](.github/instructions/copilot-instructions.md)*
...
> **Regras de Desenvolvimento**: Para instruções sobre como desenvolver seguindo os padrões do projeto, consulte [.github/instructions/copilot-instructions.md](.github/instructions/copilot-instructions.md)
